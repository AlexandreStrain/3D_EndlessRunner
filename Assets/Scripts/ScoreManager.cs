    ...
    class Leaderboard
    {
        ...
        public void Update()
        {
            ...
            if (place < 0)
            {
                ...
                if (PlayerController.Instance.jump == 1 || Input.GetButtonDown(InputNames.jumpButton))
                {
                    //Reset level
            ...
            else
            {
                ...
                else if (PlayerController.Instance.slide == 1 || Input.GetButtonDown(InputNames.slideButton))
                {
                    entriesUI[place].initials[curInitial].enabled = true;
